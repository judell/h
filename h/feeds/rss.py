...
def _feed_item_from_annotation(annotation, annotation_url, bouncer_url):
    ...
    return {
        ...
        "description": h.feeds.util.description_with_direct_link(bouncer_url, annotation),
...
def feed_from_annotations(annotations, annotation_url, rss_url, html_url, bouncer_url,
                          title, description):
    ...
    feed = {
        ...
        'entries': [
            _feed_item_from_annotation(annotation, annotation_url, bouncer_url)
